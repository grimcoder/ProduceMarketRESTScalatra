...
case class Sale (@Key("_id") Id: Option[String], Date: Date, SaleDetails: List[SaleDetail])

case class SaleDetail(ItemName: String, Price: Double, Units : Int){

}

case class PriceChange (@Key("_id") Id: Option[String], Price: Double, ItemName: String, priceWas : Option[Double], Action: String) {
